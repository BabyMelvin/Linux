#ifndef __USB_LINUX_H__
#define __USB_LINUX_H__
#ifdef __cplusplus
extern "C" {
#endif
...
/* Returns a USB descriptor string for the given string ID.
   ...
   */
int usb_device_get_string_ucs2(struct usb_device* device, int id, int timeout, void** ucs 2_out, size_t* response_size);
